...
<code>ssh -R 1008:127.0.0.1:2048 root@gmcsurat.edu.in</code>\
Now you can excess target computer with following command\
<code>ssh root@gmcsurat.edu.in:1008</code>\
...
- in /etc/passwd in coss.com, replace shell of *mytunnel* from /bin/bash to /bin/false
- add *-f -N* in above commands
<code>ssh -f -N -R 1008:127.0.0.1:80 root@boss.com</code>\
<code>ssh -f -N -R 1008:127.0.0.1:2048 root@gmcsurat.edu.in</code>\
